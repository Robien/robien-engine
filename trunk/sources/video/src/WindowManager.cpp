...
WindowManager::WindowManager(int height ,int width, int bits,int flags, std::string name)
{	flags |= SDL_OPENGL;
	SDL_Init(SDL_INIT_VIDEO);
	SDL_SetVideoMode(height, width, bits, flags);
