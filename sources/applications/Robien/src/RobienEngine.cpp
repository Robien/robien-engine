...
Object* cube()
{
    ...
    vert->push_back(new ColoredPoint(new Vector3f(1, -1, -1), new Color(2, -1, 0)));//--ici on est obligé de remettre la meme couleur
    ...
    vert->push_back(new ColoredPoint(new Vector3f(-1, -1, 1), new Color(-1, -1, 0)));//--ici on est obligé de remettre la meme couleur
